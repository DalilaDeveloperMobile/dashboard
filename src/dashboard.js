...
function Dashboard() {
  ...
  return (
    <div>
      <h1>Dashboard</h1>
      {/* Vamos Implementar o Gráfico de Pizza */}
      <Chart
        width={'400px'}
        height={'300px'}
        chartType={'PieChart'}
      ...
      {/* Vamos Implementar o Gráfico de Pizza em 3D */}
      <Chart
        width={'400px'}
        height={'300px'}
        chartType={'PieChart'}
      ...
      {/*Vamos Implementar o Gráfico de Pizza vazado(rosca)*/}
      <Chart
        width={'400px'}
        height={'300px'}
        chartType={'PieChart'}
      ...
      {/*Vamos Implementar o Gráfico de Barras*/}
      <Chart
        width={'400px'}
        height={'300px'}
        chartType={'BarChart'}
      ...
      {/*Vamos Implementar o Gráfico de Linhas*/}
      <Chart
        width={'400px'}
        height={'300px'}
        chartType={'LineChart'}
      ...
      {/*Vamos Implementar o Gráfico de Área*/}
      <Chart
        width={'400px'}
        height={'300px'}
        chartType={'AreaChart'}
